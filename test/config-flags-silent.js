...
describe('config: flags.silent', function() {
  ...
  it('Should be silent with --silent event if `flags.silent` is false in ' +
  '\n\t.gulp.*', function(done) {
    runner
      .chdir('flags/silent/f')
      .gulp('--silent')
  ...
  it('Should be silent with -S event if `flags.silent` is false in ' +
  '\n\t.gulp.*', function(done) {
    runner
      .chdir('flags/silent/f')
      .gulp('-S')
  ...
  it('Should not be silent with --silent=false event if `flags.silent` is ' +
  'true\n\tin .gulp.*', function(done) {
    runner
      .chdir('flags/silent/t')
      .gulp('--silent=false')
      .run(cb);
  ...
  it('Should not be silent with -S false event if `flags.silent` is true in ' +
  '\n\t.gulp.*', function(done) {
    runner
      .chdir('flags/silent/t')
      .gulp('-S false')
